                ...
                <div class="col-md-4 mt-3">
                    <div class=" text-center text-light">
                        <div class="row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="sumit" class="btn btn-primary">Nhập</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="col-md-4 py-2 px-0">
                                <a href="{{ route('sanpham.xuat') }}" class="text-light text-decoration-none d-inline-block w-75"><button class="btn bg-danger text-light w-100"><i class="bi bi-arrow-bar-up me-2"></i>Xuất Excel</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td style="width:100px;">
                                <a href="{{ route('sanpham.sua',$value->id) }}" title="Sửa" class="text-light py-1 px-2 bg-primary me-1"><i class="bi bi-pencil-fill"></i></a>
                                <a href="{{ route('sanpham.xoa',$value->id) }}" title="Xóa" onclick="return confirm('Bạn cos chắc muốn xóa {{$value->tensanpham}}')" class="text-light py-1 px-2 bg-danger"><i class="bi bi-trash-fill"></i></a>
                            </td>
                        </tr>
                        @endforeach
                        @else
                        <tr>
                            <td colspan="9" class="text-center">Không có bản ghi!</td>
                        </tr>
                        @endif
